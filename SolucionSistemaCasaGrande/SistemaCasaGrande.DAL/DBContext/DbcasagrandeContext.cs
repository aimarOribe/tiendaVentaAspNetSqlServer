...
namespace SistemaCasaGrande.DAL.DBContext;

public partial class DbcasagrandeContext : DbContext
{
    public DbcasagrandeContext()
    {
    }

    public DbcasagrandeContext(DbContextOptions<DbcasagrandeContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C73505790");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FC217FBBD");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48342395040");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E10741B9A9BE");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EEE9F7574");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132BC68C672");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F7675AB7A51");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D87CD746B6");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEEBF1F093");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A64FD8B6FC");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614C400E9B9");
